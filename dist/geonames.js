...
Object.defineProperty(exports, "__esModule", { value: true });
exports.geoNamesAPI = exports.baseUriCommercial = exports.baseUri = exports.baseParams = void 0;
exports.baseParams = {
    encoding: 'JSON',
    formatted: true,
    lan: 'en',
...
function Geonames(options) {
    const createInstance = (options) => {
        ...
        const config = Object.assign(Object.assign({}, geonames_config_1.baseParams), options);
        const { username, token } = config;
        const geonamesInstance = {
            options,
            config,
            version: package_json_1.default.version,
            uri: token ? geonames_config_1.baseUriCommercial : geonames_config_1.baseUri
        };
        const api = axios_1.default.create({ baseURL: geonamesInstance.uri });
        for (let apiName of geonames_config_1.geoNamesAPI) {
            const fullApiName = `${apiName}${geonamesInstance.config.encoding}`;
            geonamesInstance[apiName] = async (apiParams) => {
                const response = await api.get(fullApiName, {
                    params: Object.assign(Object.assign(Object.assign({ username }, (token && { token })), { lang: geonamesInstance.config.lan }), apiParams),
...
module.exports = __webpack_require__(/*! J:\webz\geonames.js\src\geonames.ts */"./geonames.ts");
